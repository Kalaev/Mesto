...
const createButton = document.querySelector(".popup_add-profile__create");
const closeAddButton = document.querySelector(".popup_add-profile__close");
...
const createForm = document.querySelector(".popup_add-profile__content");
